                        ...
                        <div class="card-body">
                            <form action="{{ route('users.update', $user) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">
                                                Dejar en blanco para mantener la contraseña actual. Mínimo 8 caracteres si se cambia.
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="photo" class="form-label">Nueva Foto de Perfil</label>
                                            <input type="file" 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" id="photoPreview" style="display: none;">
                                        <div class="form-group">
                                            <label class="form-label">Nueva Foto (Vista Previa):</label>
                                            <div class="text-center">
                                                <img id="previewImage" 
                                     src="" 
                                     alt="Vista previa" 
                                    ...
                                    <div class="col-12">
                                        <div class="alert alert-info">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <strong>Creado:</strong> {{ $user->createdAt ? $user->createdAt->format('d/m/Y H:i') : 'N/A' }}
                                                </div>
                                                <div class="col-md-4">
                                                    <strong>Actualizado:</strong> {{ $user->updatedAt ? $user->updatedAt->format('d/m/Y H:i') : 'N/A' }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-0">
                                            ...
                                            <a href="{{ route('users.show', $user) }}" class="btn btn-info ml-2">
                                                <i class="fas fa-eye"></i> Ver
                                            </a>
